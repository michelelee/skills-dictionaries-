...
stirng1 = "Hello, I like to eat ice cream and cookies and sushi and mac and cheese."
...
def count_unique(string1):
    ...
    for w in string1:
        unique_word_dict[word] = unique_word_dict.setdefault(word, 0) + 1
    ...
    # string1 = string1.split()
    # #dont need .read() because it is not text coming from a large file, this is already a string. 

    # unique_words_dictonary = {}


    # for word in imported_string:
    #     key= imported_string[index]


    #     unique_words_dictonary[key].append(+ 1)
